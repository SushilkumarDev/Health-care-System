        ...
        preConfirm: () => {
            ...
            const roomPassword =
                isRoomLocked && (room_password || rc.RoomPassword)
                    ...
                    : '';
            const email = '';
            const emailSubject = `Please join our Meetme Video Chat Meeting`;
    ...
    Swal.fire({
        ...
        <div id="about">
            <button 
                ...
                class="pulsate" 
                onclick="window.open('mailto:sushilkumaryadav9545@gmail.com')">
            ...
            Email:<a 
                ...
                href="mailto:sushilkumaryadav9545@gmail.com?subject=Meetmee info"> 
